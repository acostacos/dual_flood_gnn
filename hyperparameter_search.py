...
def objective(trial: optuna.Trial) -> float:
    global_mass_loss_percent = trial.suggest_float('global_mass_loss_percent', 0.00001, 0.0001, log=True) if use_global_mass_loss else None
    local_mass_loss_percent = trial.suggest_float('local_mass_loss_percent', 0.00001, 0.0001, log=True) if use_local_mass_loss else None
